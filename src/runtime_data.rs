...
/// This function dumps the `OhuaData` structure to the `runtime.rs` file. Intentionally
/// takes ownership of the OhuaData struct as this should be the last operation performed
